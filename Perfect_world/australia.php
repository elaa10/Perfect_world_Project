...
<body>
<section class="australia-header">
    <video autoplay loop muted plays-inline class="back-video">
    		      <source src="images/australia.mp4" type="video/mp4">
    		  </video>
	<nav>
...
<section class="australia">
	<div class="rowt">
		...
		<div class="informatii">
			<h3>Australia de Vest</h3>
			<p>Australia de Vest este o regiune cu peisaje dramatice și un farmec de neegalat, acoperind o treime din întregul continent. Aici, oceanul turcoaz întâlnește deșertul roșiatic, creând contraste vizuale absolut hipnotizante. De la plajele nesfârșite și neatinse din sud-vest, până la formațiunile stâncoase străvechi din regiunea Kimberley și minunile marine din Ningaloo Reef, unde poți înota alături de rechinii-balenă, fiecare colț este o aventură. Capitala sa, Perth, adaugă un strop de vibrație urbană relaxată, făcând din Australia de Vest destinația ideală pentru cei care caută explorare pură și conexiune autentică cu natura.</p>

			<div class="plan">
				<h4>Experiențe de neuitat</h4>
				<p>Explorează peisajele ireale ale deșertului Pinnacles, bucură-te de soare pe superbele plaje din Margaret River și lasă-te fascinat de natura sălbatică unică a acestui tărâm spectaculos.</p>
			</div>

			<div class="harta">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3549721.5794828197!2d113.84279093033503!3d-25.558364379361664!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2a32c4e6da207e41%3A0x100f6b4e3415c50!2sWestern%20Australia%2C%20Australia!5e0!3m2!1sen!2sro!4v1700000000000!5m2!1sen!2sro" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
		</div>
	</div>
</section>
