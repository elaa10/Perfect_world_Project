...
<body>
<section class="jamaica-header">
    <video autoplay loop muted plays-inline class="back-video">
    		<source src="images/dominicana.mp4" type="video/mp4">
    	</video>
	<nav>
...
<section class="jamaica">
	<div class="rowt">
		<div class="square-img"></div>
		<div class="informatii">
			<h3>Jamaica</h3>
			<p>Jamaica este o insulă plină de viață, renumită pentru spiritul său vibrant, ritmurile de reggae și peisajele tropicale luxuriante. De la celebrele plaje cu nisip alb din Negril și Montego Bay, până la apele răcoroase ale cascadelor Dunn’s River, Jamaica oferă o combinație perfectă de relaxare și aventură. Cultura sa este la fel de bogată ca și natura, cu o gastronomie explozivă, influențată de aromele locale și condimentele jerk, transformând fiecare vizită într-o experiență de suflet, de neuitat.</p>

			<div class="plan">
				<h4>Ritm și relaxare</h4>
				<p>Relaxează-te pe plajele paradisiace, bucură-te de soare, savurează delicioasa cafea Blue Mountain și lasă-te purtat de ritmurile muzicii într-una dintre cele mai colorate destinații din Caraibe.</p>
			</div>

			<div class="harta">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1933092.4277712398!2d-78.53664369466652!3d18.10958117937965!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8eda2a1aea6601cb%3A0xcf76f7f45771d9d!2sJamaica!5e0!3m2!1sen!2sro!4v1700000000000!5m2!1sen!2sro" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
		</div>
	</div>
</section>
