...
<body>
<section class="marsilia-header">
	<video autoplay loop muted plays-inline class="back-video">
		<source src="images/marsilia.mp4" type="video/mp4">
	</video>
	<nav>
	...
	<div class="text-box">
		<h1>MARSILIA, FRANȚA</h1>
		<p>Cele mai frumoase locuri de vizitat din toată lumea</p>
	</div>
</section>

<section class="marsilia">
	<div class="rowt">
		<div class="square-img"></div>

		<div class="informatii">
			<h3>MARSILIA, Franța</h3>
			<p>Marsilia are atât zonă de plajă, cât și urbană, este franceză și mediteraneană, modernă și istorică.
				Mergeți la plajă în mod obligatoriu, cutreierați cartierele sale diverse, admirați arta stradală și tururile arhitecturale, precum și picturile rupestre care datează de 20.000 de ani, adăpostite acum de un muzeu nou.</p>
			<div class="plan">
				<h4>Planifică-ți călătoria</h4>
				<div class="harta">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d185896.01366474762!2d5.2158390235191625!3d43.28022699623146!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12c9bf4344da5333%3A0x40819a5fd970220!2sMarsilia%2C%20Fran%C5%A3a!5e0!3m2!1sro!2sro!4v1683541357046!5m2!1sro!2sro" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			</div>
		</div>
	</div>
