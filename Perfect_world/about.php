...
<section class="about">
	<div class="rowt">
		...
		<div class="informatii">
			<p>"The Perfect World" este platforma ta de inspirație pentru cele mai captivante și deosebite destinații din întreaga lume.
				Misiunea noastră este să te ajutăm să descoperi locuri spectaculoase, de la orașe vibrante și pline de cultură,
				până la refugii liniștite în inima naturii, transformând fiecare vis într-o călătorie reală și memorabilă.</p>

			<div class="plan">
				<h4>Ne angajăm să oferim:</h4>
				<p>1. <b>O selecție de top:</b> Explorăm și testăm destinații, selectând doar acele locuri care promit experiențe remarcabile, pe care le poți trece cu încredere pe lista ta de dorințe.</p>
				<p>2. <b>Ghiduri de încredere:</b> De la secrete locale, la atracții de neratat, fiecare ghid este creat pentru a-ți asigura o planificare fără stres.</p>
				<p>3. <b>Inspirație vizuală și informativă:</b> Povestim despre frumusețea lumii prin imagini captivante și detalii atent documentate, aducând fiecare loc mai aproape de tine.</p>
				<p>4. <b>Angajament pentru sustenabilitate:</b> Încurajăm turismul responsabil și sprijinim inițiative care protejează peisajele și comunitățile locale pe care le vizităm.</p>
			</div>
		</div>
	</div>
</section>
