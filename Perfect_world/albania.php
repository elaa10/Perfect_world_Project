...
<body>
<section class="albania-header">
	<video autoplay loop muted plays-inline class="back-video">
		<source src="images/albania.mp4" type="video/mp4">
	</video>
	<nav>
...
<section class="albania">
	<div class="rowt">
		<div class="square-img"></div>

		<div class="informatii">
			<h3>ALBANIA</h3>
			<p>În puține locuri îți poți începe ziua la munte și să o închei la mare. Frumusețea naturală a Albaniei îți va taia răsuflarea.
				Poporul albanez este unul dintre cel mai prietenos din întreaga lume. Dacă nu găsești o stradă sau dacă ai nevoie de orice fel de informații, localnicii te vor ajuta cu plăcere.
				Este un mare plus dacă poți vorbi italiană sau germană, pentru că mulți albanezi au lucrat în acele țări înainte, dar tinerii vorbesc engleza, așa că nu sunt probleme.</p>
			<div class="plan">
				<h4>Planifică-ți călătoria</h4>
				<div class="harta">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3077811.432373425!2d17.385784622010938!3d41.119783500319116!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13453bf3bd274c2d%3A0x77ce589d6983bee!2sAlbania!5e0!3m2!1sro!2sro!4v1683538411078!5m2!1sro!2sro" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			</div>
		</div>
	</div>
